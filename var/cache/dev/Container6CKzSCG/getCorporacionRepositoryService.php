...
// Returns the private 'App\Repository\CorporacionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CorporacionRepository.php';

return $this->privates['App\Repository\CorporacionRepository'] = new \App\Repository\CorporacionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
