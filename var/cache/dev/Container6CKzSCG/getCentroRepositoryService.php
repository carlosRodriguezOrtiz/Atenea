...
// Returns the private 'App\Repository\CentroRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CentroRepository.php';

return $this->privates['App\Repository\CentroRepository'] = new \App\Repository\CentroRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
