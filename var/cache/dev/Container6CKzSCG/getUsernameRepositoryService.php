...
// Returns the private 'App\Repository\UsernameRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UsernameRepository.php';

return $this->privates['App\Repository\UsernameRepository'] = new \App\Repository\UsernameRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
