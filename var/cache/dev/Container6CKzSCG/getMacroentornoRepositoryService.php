...
// Returns the private 'App\Repository\MacroentornoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MacroentornoRepository.php';

return $this->privates['App\Repository\MacroentornoRepository'] = new \App\Repository\MacroentornoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
