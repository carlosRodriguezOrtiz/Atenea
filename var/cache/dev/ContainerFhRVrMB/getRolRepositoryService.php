...
// Returns the private 'App\Repository\RolRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RolRepository.php';

return $this->privates['App\Repository\RolRepository'] = new \App\Repository\RolRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
