...
return $this->privates['security.authentication.rememberme.services.simplehash.main'] = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices([0 => ($this->privates['security.user.provider.concrete.our_db_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_OurDbProviderService.php'))], 'kernel.secret', 'main', ['lifetime' => 604800, 'path' => '/', 'always_remember_me' => false, 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => NULL, 'httponly' => true, 'samesite' => 'lax', 'remember_me_parameter' => '_remember_me'], ($this->privates['monolog.logger.security'] ?? $this->load('getMonolog_Logger_SecurityService.php')));
