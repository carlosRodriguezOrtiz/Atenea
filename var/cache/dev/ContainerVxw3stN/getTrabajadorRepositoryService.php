...
// Returns the private 'App\Repository\TrabajadorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrabajadorRepository.php';

return $this->privates['App\Repository\TrabajadorRepository'] = new \App\Repository\TrabajadorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
